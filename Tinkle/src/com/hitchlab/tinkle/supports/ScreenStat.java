...
public class ScreenStat {
	...
	//get the height of the view given its side padding in dp
	public static int getViewHeight(Context context, int topPadding, int bottomPadding) {
		//first we transform the padding into pixel
		WindowManager w = (WindowManager) context.getSystemService(Context.WINDOW_SERVICE);
		Display d = w.getDefaultDisplay();
		DisplayMetrics metrics = new DisplayMetrics();
		...
		int paddingTop = (int) (topPadding * density);
		int paddingBottom = (int) (bottomPadding * density);
